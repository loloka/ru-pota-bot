...
export default function RouteModal({ park, onClose, language = 'RU' }) {
  ...
  const modalContent = (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4 pt-10 pb-safe select-none">
      {/* Backdrop */}
      <div 
      ...
      {/* Modal Card */}
      <div className="relative w-full max-w-sm max-h-[85dvh] sm:max-h-[90dvh] flex flex-col rounded-t-3xl sm:rounded-3xl glass-card p-4 sm:p-5 shadow-2xl border border-slate-300 dark:border-slate-800 animate-slide-up z-10 overflow-hidden">
        {/* Mobile Drag Indicator */}
        <div className="w-10 h-1 rounded-full bg-slate-300 dark:bg-slate-700 mx-auto -mt-1 mb-2 sm:hidden shrink-0" />
        ...
        <div className="overflow-y-auto overscroll-contain space-y-3 pr-0.5 -mr-0.5 my-1">
          {/* Park info banner */}
