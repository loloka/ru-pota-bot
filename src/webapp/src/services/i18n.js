...
export const translations = {
  RU: {
    ...
    guest_profile_desc: 'Войдите через Telegram-бота или напрямую через сайт по Email, чтобы привязать позывной, отправлять споты в эфир и отслеживать статистику.',
    guest_subs_title: 'Персональные подписки',
    guest_subs_desc: 'Бот пришлёт уведомление в Telegram (если аккаунт привязан к боту), а также покажет спот во вкладке «Входящие споты» со звуковым сигналом.',
    guest_stats_hint: 'Доступно после авторизации',
    guest_subs_hint: 'Доступно после авторизации',
    ...
    subs_feed_tab: 'Входящие споты',
    subs_rules_tab: 'Мои подписки',
    subs_sound_on: 'Звук вкл',
    subs_sound_off: 'Без звука',
    subs_mark_all_read: 'Прочитано',
    subs_clear_all: 'Очистить',
    subs_empty_feed_title: 'Нет входящих спотов',
    subs_empty_feed_desc: 'Когда отслеживаемый позывной или парк появится в эфире, здесь сразу прозвучит сигнал и появится карточка спота.',
  ...
  EN: {
    ...
    guest_profile_desc: 'Sign in via Telegram bot or directly on the website with your Email to link your callsign, post spots on air and track statistics.',
    guest_subs_title: 'Personal Subscriptions',
    guest_subs_desc: 'The bot alerts you in Telegram (if account is linked), and delivers live spots with sound alerts in the web feed.',
    guest_stats_hint: 'Available after sign in',
    guest_subs_hint: 'Available after sign in',
    dash_on_air: '● ON AIR',
    ...
    subs_feed_tab: 'Incoming Spots',
    subs_rules_tab: 'My Subscriptions',
    subs_sound_on: 'Sound On',
    subs_sound_off: 'Muted',
    subs_mark_all_read: 'Mark Read',
    subs_clear_all: 'Clear All',
    subs_empty_feed_title: 'No incoming spots yet',
    subs_empty_feed_desc: 'When a followed callsign or park spots on air, a radio chime will play and the spot will appear here.',
