...
console.log(`✅ PASS: Summary stats verified (Total potential: ${stats.summary.totalPotentialParks}, Mature regions: ${stats.summary.matureRegionsCount}, Overall coverage: ${stats.summary.overallCoverageRate}%)`);
